...
def atmcorr(altitude, input_variables, iLUTs):
  ...
  for v in input_variables:  
    ...
    if stats['count_nir'] > 0:
      ...
      coeffs = {
      'fileID':v['fileID'],
      'blue':iLUT['blue'](v['solar_z'],v['H2O'],v['O3'],AOT,alt),
      'green':iLUT['green'](v['solar_z'],v['H2O'],v['O3'],AOT,alt),
      'red':iLUT['red'](v['solar_z'],v['H2O'],v['O3'],AOT,alt),
      'nir':iLUT['nir'](v['solar_z'],v['H2O'],v['O3'],AOT,alt),
      'swir1':iLUT['swir1'](v['solar_z'],v['H2O'],v['O3'],AOT,alt),
      'swir2':iLUT['swir2'](v['solar_z'],v['H2O'],v['O3'],AOT,alt)
      }
...
def write_outputs(outputs):
  ...
  with open('/home/sam/Desktop/atmcorr_outputs.csv', 'w') as outfile:
    ...
    writer.writerow(['fileID b_Edir b_Edif b_tau2 b_Lp '
    ...
    for out in outputs:    
      ...
      writer.writerow(['{} {} {} {} {} {} {}'.format(ID,b,g,r,n,s1,s2)])
